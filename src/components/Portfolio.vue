...
export default {
  ...
  computed:{
    ...
    portfolioFilter() {
        // return this.portfolioList.filter(item => item.catagory.includes(this.keyword))
        // return this.portfolioList.filter(item => portfolioList.tech.includes(this.keyword))
    },
    siteFilter() {
